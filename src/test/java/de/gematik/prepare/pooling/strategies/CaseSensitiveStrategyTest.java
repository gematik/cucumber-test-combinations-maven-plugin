...
class CaseSensitiveStrategyTest {

  private static Stream<Arguments> testCaseInsensitiveExact() {
    return Stream.of(
        arguments(List.of("TEstGroup"), Set.of("testgrOup"), NOT_MATCHING),
  ...
  void testCaseInsensitiveExact(List<String> groups, Set<String> itemGroups, String result) {
    CaseSensitiveStrategy underTest = new CaseSensitiveStrategy(groups);
